      ...
      {branches.length === 0 ? (
        <p className="text-sm text-muted">
          {policy.status === "locked"
            ? "Policy locked. The agent can now create isolated futures from MAIN."
            : "Lock HUMAN POLICY before the agent creates any candidate future."}
        </p>
      ) : (
        <>
          <p className="mb-2 text-[11px] leading-relaxed text-muted">
            Verification tells you what is allowed. You decide what becomes
            real.
          </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-2 flex gap-2">
                    ...
                    >
                      {approved ? "Approved for Merge" : "Approve for Merge"}
                    </Button>
                    <Button
                      variant="ghost"
                      disabled={!approved}
